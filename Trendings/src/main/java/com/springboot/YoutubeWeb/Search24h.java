...
public class Search24h {
  ...
  public static void main(String[] args) {
    ...
    try {
      InputStream in = Search24h.class.getResourceAsStream("/" + PROPERTIES_FILENAME);
      properties.load(in);
    ...
    while (iteratorSearchResults.hasNext()) {
      ...
      //Insert BD
		try {
			...
			String queryI = "INSERT INTO youtube24 (title,url,created_on,last_login) VALUES ( '"+title+"','"+ videos +"', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP )";
