...
public class GoogleAuthenticator {
	...
	private String _username = "marcmateo97@gmail.com";
	  private String _passwd = "jbond009";
	  ...
	  public GoogleAuthenticator(String username, String passwd, HttpClient httpClient) {
	    _username = "marcmateo97@gmail.com";
	    _passwd = "jbond009";
	  ...
	  private boolean login(String galx) throws GoogleAuthenticatorException {
	    ...
	    try {
	      ...
	      httpPost.setEntity(new UrlEncodedFormEntity(setupFormInputs(config, galx), Consts.UTF_8));
